...
const skill = [
  { lang: 'Python', metric: 95, color: 'green' },

  { lang: 'HTML/CSS', metric: 88, color: 'purple' },

  { lang: 'SQL', metric: 85, color: 'blue' },

  { lang: 'Javascript', metric: 79, color: 'yellow' },

  { lang: 'C++/C', metric: 75, color: 'slate' },

  { lang: 'Java', metric: 65, color: 'red' },
];
